                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-blue-800 text-sm">
                        Selecione a bandeira do seu cartão: <span className="text-red-500">*</span>
                      </h4>

                      <RadioGroup value={selectedCardBrand} onValueChange={setSelectedCardBrand}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              />
                              <Label htmlFor="visa" className="cursor-pointer font-medium text-sm">
                                Visa
                              </Label>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            ...
                            <div className="flex items-center space-x-2">
                              <img
                                ...
                                className="w-10 h-6 object-contain"
                              />
                              <Label htmlFor="mastercard" className="cursor-pointer font-medium text-sm">
                                Mastercard
                              </Label>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            ...
                            <div className="flex items-center space-x-2">
                              <img
                                ...
                                className="w-10 h-6 object-contain"
                              />
                              <Label htmlFor="elo" className="cursor-pointer font-medium text-sm">
                                Elo
                              </Label>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            ...
                            <div className="flex items-center space-x-2">
                              <img
                                ...
                                className="w-10 h-6 object-contain"
                              />
                              <Label htmlFor="amex" className="cursor-pointer font-medium text-sm">
                                American Express
                              </Label>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            <RadioGroupItem value="hipercard" id="hipercard" />
                            <div className="flex items-center space-x-2">
                              <img
                                src="/placeholder.svg?height=24&width=38&text=HIPER"
                                alt="Hipercard"
                                className="w-10 h-6 object-contain"
                              />
                              <Label htmlFor="hipercard" className="cursor-pointer font-medium text-sm">
                                Hipercard
                              </Label>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-white transition-colors">
                            <RadioGroupItem value="diners" id="diners" />
                            <div className="flex items-center space-x-2">
                              <img
                                src="/placeholder.svg?height=24&width=38&text=DINERS"
                                alt="Diners Club"
                                className="w-10 h-6 object-contain"
                              />
                              <Label htmlFor="diners" className="cursor-pointer font-medium text-sm">
                                Diners Club
                              </Label>
                            </div>
                          </div>
                      ...
                      {selectedCardBrand && (
                        <div className="mt-4 bg-green-50 p-3 rounded-lg border border-green-200">
                          <p className="text-sm text-green-800">
                            ✅ <strong>Bandeira selecionada:</strong>{" "}
                            {selectedCardBrand === "visa"
                              ? "Visa"
                              : selectedCardBrand === "mastercard"
                                ? "Mastercard"
                                : selectedCardBrand === "elo"
                                  ? "Elo"
                                  : selectedCardBrand === "amex"
                                    ? "American Express"
                                    : selectedCardBrand === "hipercard"
                                      ? "Hipercard"
                                      : selectedCardBrand === "diners"
                                        ? "Diners Club"
                                        : ""}
                          </p>
                        </div>
